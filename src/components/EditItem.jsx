                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="border rounded-md text-xs w-80 p-2 border border-gray-300 block mx-auto  mt-1" required
                                    defaultValue="Lorem ipsum began as scrambled, nonsensical Latin derived from Cicero’s 1scentury BC text De Finibus Bonorum et Malorum."
                                />
                            </div>
                            <div className="form-group">
                                ...
                                defaultValue="It’s not Latin, though it looks like it, and it actually says nothing,” Before & After magazine answered a curious reader, 
